...
{
    const res = new CanvasImage(width, height);
    ...
    for (let y = 0; y < bitmap.height; y++)
    {
        for (let x = 0; x < bitmap.width; x++)
        {
            ...
            if (scale == 1)
            {
                ...
                res.data[ptr + 1] = g;
                res.data[ptr + 2] = b;
                res.data[ptr + 3] = ConstantsList.globalAlpha;
                continue;
            }
...
export function lerpVector3(a, b, c, w0, w1, w2)
{
    ...
    return new demension3_vec(wa.x + wb.x + wc.x, wa.y + wb.y + wc.y, wa.z + wb.z + wc.z);
}
...
export function lerp2AttributeVec3(a, b, w0, w1, z0, z1, z)
{
    ...
    return new demension3_vec(wa.x + wb.x, wa.y + wb.y, wa.z + wb.z);
}
...
export function lerp3AttributeVec2(a, b, c, w0, w1, w2, z0, z1, z2, z)
{
    ...
    return new demension2_vec(wa.x + wb.x + wc.x, wa.y + wb.y + wc.y);
}
...
export function convertColor2VectorRange1(hex)
{
    ...
    return new demension3_vec(r, g, b);
}
...
export function clipColorVector(vec3)
{
    ...
    return new demension3_vec(nr, ng, nb);
}
